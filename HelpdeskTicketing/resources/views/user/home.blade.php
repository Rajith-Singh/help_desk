          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="user_option">
              <a href="">
                ...
                <a href="{{route('login')}}"> Login</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
  ...
  <section class="info_section ">
    <div class="info_container layout_padding-top">
      <div class="container">
        <div class="info_top">
          <div class="info_logo">
            <img src="Arrogance_logo_v1.1.png" alt="" />
